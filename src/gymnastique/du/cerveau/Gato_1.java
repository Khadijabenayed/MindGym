 ...
 * @author dell
 */
public class Gato_1 extends javax.swing.JFrame implements ActionListener {
 Casilla [][]TABLERO;
    int Contador;
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gato_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
